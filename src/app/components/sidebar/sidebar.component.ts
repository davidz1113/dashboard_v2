...
export const ROUTES: RouteInfo[] = [
    ...
    { path: '/' + GLOBAL.urlBase + '/tipopuesto', title: 'Tipos de puesto', icon: 'transfer_within_a_station', class: '', valor: 200 },
    ...
    { path: '/' + GLOBAL.urlBase + '/tarifaanimal', title: 'Tarifa animal', icon: 'description', class: '', valor: 21},
    ...
    { path: '/' + GLOBAL.urlBase + '/tablapaginada', title: 'Tabla paginjadadasdasd', icon: 'content_paste', class: '', valor: 13 },
